        ...
        <div className="md:mt-20 mt-10">
            ...
            <div className="flex gap-6 flex-col lg:flex-row">
                ...
                <div className="lg:w-6/12 lg:mt-12">
                    <p className="text-primaryColor font-semibold">ABOUT US</p>
                    <h4 className="text-4xl py-2 font-semibold">Something about this hospital and about us</h4>
                    <p className="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis explicabo modi nulla qui neque, adipisci laboriosam aspernatur. Debitis perferendis doloremque ad minus vero molestias optio aliquid in, non eum animi quo, dolorum facere sed earum?</p>
