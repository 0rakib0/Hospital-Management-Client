    ...
    return (
        <div data-aos="fade-up" className="md:mt-20 mt-10" id="service">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4  gap-4">
                <div data-aos="fade-right" className="bg-white p-4 text-center flex flex-col items-center hover:border hover:border-primaryColor duration-300 hover:rounded-lg">
                ...
                <div data-aos="fade-left" className="bg-white p-4 text-center flex flex-col items-center hover:border hover:border-primaryColor duration-300 hover:rounded-lg">
                    <div className="text-6xl text-primaryColor mb-2">
