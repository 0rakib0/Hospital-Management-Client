    ...
    return (
        <div className="flex flex-col lg:flex-row gap-4 p-6 items-center">
            ...
            <div data-aos="fade-left" className="lg:w-3/4">
                ...
                <p className="py-4">Welcome to our healthcare management system designed for efficiency and patient care excellence. At Health Care, we're dedicated to revolutionizing healthcare administration through innovative technology.</p>
