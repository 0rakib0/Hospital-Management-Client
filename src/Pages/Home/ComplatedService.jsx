...
const ComplatedService = () => {
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 md:grid-cols-3 gap-6 mt-10">
            <div data-aos="fade-right" className="flex flex-col items-center Services-card bg-white hover:rounded-lg duration-300">
            ...
            <div data-aos="fade-left" className="flex flex-col items-center Services-card bg-white hover:rounded-lg duration-300">
                <div className="text-4xl text-primaryColor">
                    <FaUsers></FaUsers>
                </div>
